//  лассификаци€ по нескольким классам.
// lwml, (c) ltwood
...
public:
  ...
  // функции calc_error(s) могут вызыватьс€ дл€ набора точек Ќ≈ на котором обучились
  ...
  // выводит таблицу веро€тностей принадлежности точки к классу, при различных ответах классификаторов
...
private:
  ...
  // считает вектор веро€тностей принадлежности к классу при условии заданного вектора ответов бинарных классификаторов
  // возвращает веро€тность данного ответа
  real calc_conditional_prob( int num, const int_vector& ab_answer, vector& conditional_prob ) const;

  // функции дл€ генерации coding_matrix
