...
public:
   ...
   * @param sc_fact  онструктор простого классификатора
   * @param vs1 Ќабор векторов первого класса
   * @param vs2 Ќабор векторов второго класса
   * @param num
   * @param tick ѕараметр прогресс индикации
   */
  ...
  )
{
  ...
  /**
   * —оздание классификатора по внешнему lua-файлу.
   * @param cnf ‘айл конфигурации
   * @param root
   */
...
private:
  ...
  // вычисл€етс€ веро€тность того, что точка, котора€ была классифицирована как класс 0/1, действительно принадлежит ему
