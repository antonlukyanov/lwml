...
// Система Лоренца с хаотическим поведением.
// Хаотическое поведение реализуется при следующих значених параметров:
...
// Система Лоренца в касательном пространстве (т.н. система в вариациях).
// Используется при расчете показателей Ляпунова.
