...
/*!
  ...
  @Todo: добавить возможность указывать значения опций в виде -optname value, а не только
...
public:
  ...
  static bool  is_opt( const char* opt_name );   // проверить наличие опции
  static strng get_opt( const char* opt_name );  // получить аргумент опции как строку
